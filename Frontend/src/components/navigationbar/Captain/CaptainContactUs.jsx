...
const CaptainContactUs = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white relative">
      <button
        className="absolute top-6 left-6 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none z-10 bg-gray-100 rounded-full p-2 "
...
export default CaptainContactUs;
