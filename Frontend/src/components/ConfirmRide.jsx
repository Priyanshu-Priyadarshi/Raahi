...
const ConfirmRide = (props) => 
{
    return (
        <div className="h-[58vh] overflow-y-auto">
            ...
            props.setConfirmRidePanel(false);
            props.createRide();
            }} className="mt-3 w-full text-white font-semibold p-2 rounded-lg bg-green-600">Confirm</button>
            </div>
        </div>
    )
}
